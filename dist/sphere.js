...
exports.DEG = exports.RAD = void 0;
exports.slerp = slerp;
exports.cart2ll = cart2ll;
exports.wrapRingForAntimeridian = wrapRingForAntimeridian;
...
function cart2ll([x, y, z]) {
    ...
    return [Math.atan2(y, x) * exports.DEG, Math.asin(clampedZ) * exports.DEG];
}
/**
 ...
 */
function wrapRingForAntimeridian(ring) {
